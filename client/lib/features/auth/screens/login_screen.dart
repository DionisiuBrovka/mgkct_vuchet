                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const ScreenHint(
                                title: 'Как войти',
                                message:
                                    'Выберите своё ФИО и введите пароль, выданный администратором. Если вас нет в списке или вы забыли пароль, обратитесь к администратору.'),
                            if (_loadError != null) ...[
                              Text(_loadError!),
                              TextButton(
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Пароль',
                                helperText: 'Пароль вашей учётной записи',
